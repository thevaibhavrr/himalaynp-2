        ...
        <div className="row align-items-center">
          <div className="col-xl-6 col-lg-6">
            <div className="about-one_content-box mb-50">
              ...
              <div className="quote-text mb-35 text-center">
              ...
              <div className="tab-content-box">
                <ul className="nav nav-tabs mb-20 justify-content-center">
                ...
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="mission">
                    <div className="content-box-gap text-center">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="about-one_image-box p-r mb-50 text-center">
              <div className="about-img_one mb-30" style={{maxWidth: '300px', height: 'auto', borderRadius: '10px', margin: '0 auto'}}>
              ...
              <div className="about-img_two" style={{maxWidth: '300px', height: 'auto', borderRadius: '10px', margin: '0 auto'}}>
